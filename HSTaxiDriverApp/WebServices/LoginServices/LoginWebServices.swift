...
class LoginWebServices: BaseWebService {
    ...
    public func signUpService(full_name:String,email:String,password:String,location:String,lat:String,lon:String, onSuccess success: @escaping (NSDictionary) -> Void, onFailure failure: @escaping (_ error: Error?) -> Void) {
        let requestDict = NSMutableDictionary.init()
            ...
            requestDict.setValue(lat, forKey: "lat")
            requestDict.setValue(lon, forKey: "lon")
    ...
    public func signInService(email:String,password:String,country_code:String,phone_no:String,type:String, onSuccess success: @escaping (NSDictionary) -> Void) {
        let requestDict = NSMutableDictionary.init()
        requestDict.setValue(email, forKey: "email")
        requestDict.setValue(password, forKey: "password")
        if type == "withphone" {

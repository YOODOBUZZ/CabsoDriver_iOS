...
class SecurityDepositPage: UIViewController {
    ...
    func setUpInitialDetails()  {
        ...
        self.titleLbl.config(color: TEXT_PRIMARY_COLOR, size: 20, align: .left, text:"security_deposit")
...
//        self.contentWebView.loadHTMLString(htmlString, baseURL: nil)
    ...
    @IBAction func agreeBtnTapped(_ sender: Any) {
        ...
        agreeObj.updateAgreement(type: "security_deposit", onSuccess: {response in
